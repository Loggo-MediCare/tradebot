"""
Batch Training Script for Taiwan Stocks (Batch 5)
Trains: 1717, 3049, 8096, 3149, 3532, 1789, 3691
Note: 6239 already trained
"""
import subprocess
import sys
import os
...
if __name__ == "__main__":
    print("="*70)
    print("Batch Training for Taiwan Stocks (Batch 5)")
    print("="*70)
