"""
Batch Training Script for Taiwan Stocks (Batch 4)
Trains: 6949, 3081, 8046, 3189, 5864, 5347, 2485, 4533, 7709, 4534, 8299
Note: 6285 and 7717 are already being trained in other batches
"""
import subprocess
import sys
import os
...
TW_STOCKS = [
    '6949', '3081', '8046', '3189', '5864', '5347',
    '2485', '4533', '7709', '4534', '8299'
]
...
if __name__ == "__main__":
    print("="*70)
    print("Batch Training for Taiwan Stocks (Batch 4)")
    print("="*70)
