...
MODEL_FILE = 'xgb_3450_tw_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (聯鈞) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 3450 聯鈞 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('3450', '聯鈞', max_results=5)