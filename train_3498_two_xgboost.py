...
TICKER = '3498.TWO'
print(f"訓練 {TICKER} (陽程) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_3498_two_model.pkl')
    print(f"\n模型已保存: xgb_3498_two_model.pkl")
    ...
    with open('model_accuracy_3498_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('3498_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
