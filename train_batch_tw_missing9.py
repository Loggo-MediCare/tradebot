"""Train XGBoost + PPO for 9 remaining stocks missing models"""
...
STOCKS = [
    ('5289', '宜鼎',    'TWO'),  # fixed: TWO not TW
    ('3055', '蔚華科',  'TW'),   # fixed: TW not TWO
    ('7610', '聯友金屬', 'TW'),  # fixed: TW not TWO
    ('5215', '科嘉-KY', 'TW'),  # fixed: TW not TWO
    ('3691', '碩禾',    'TWO'),  # fixed: TWO not TW
    ('7788', '兆川精密', 'TW'),  # fixed: TW not TWO
    ('3264', '欣銓',    'TWO'),  # fixed: TWO not TW
    ('6257', '矽格',    'TW'),   # fixed: TW not TWO
    ('3587', '閎康',    'TWO'),  # fixed: TWO not TW
]
...
if __name__ == '__main__':
    print("=" * 60)
    print(f"  Training 9 remaining stocks")
