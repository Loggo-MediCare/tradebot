...
def get_trading_signal():
    ...
    print("🤖 台股 6415 (矽力-KY) AI 交易信号生成器")
    ...
    accuracy_display = get_model_accuracy_display('6415.TW')
    ...
    model_path = r"C:\Users\Silvi\Projects\trading-bot\ppo_6415_tw_improved"
    ...
    try:
        ...
        df = yf.download('6415.TW', period='2y', progress=False, auto_adjust=True)
        ...
        try:
            ...
            ticker_info = yf.Ticker('6415.TW').info
    ...
    weight_calc = DynamicWeightCalculator('6415.TW')
    ...
    sentiment_result = calculate_sentiment_score('6415.TW', verbose=False)
    ...
    if action_value > 0.1:
        ...
        buy_score, signal_override, buy_reasons, buy_warnings, buy_metadata, sentiment_result = \
            calculate_enhanced_buy_score_with_sentiment(
                ...
                ai_action=action_value, buy_weights=buy_weights, symbol='6415.TW'
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            chart_df = yf.Ticker("6415.TW").history(period="6mo")


            chart_df.columns = [c.lower() for c in chart_df.columns]


            chart_path = "6415_chart.png"


            plot_candlestick(chart_df, "6415.TW", save_path=chart_path)
        ...
        print(f"   股票: {result['symbol']} (矽力-KY)")
        ...
        print(f"   {get_model_accuracy_display('6415.TW')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 6415 矽力-KY 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('6415', '矽力-KY', max_results=5)