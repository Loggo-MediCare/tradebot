"""
批量訓練主要台股 XGBoost 模型
2330.TW 台積電, 2308.TW 台達電, 2317.TW 鴻海
"""
import os
...
# 股票列表
STOCKS = [
    {'ticker': '2330.TW', 'name': '台積電', 'code': '2330'},
    {'ticker': '2308.TW', 'name': '台達電', 'code': '2308'},
    {'ticker': '2317.TW', 'name': '鴻海', 'code': '2317'},
]
...
def train_stock(ticker, name, code):
    ...
    try:
        ...
        with open(f'{code}_TW_feature_importance.json', 'w', encoding='utf-8') as f:
