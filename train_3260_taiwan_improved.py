...
# 2. 下载和处理数据
# ==========================================
def download_and_prepare_data(ticker='1101.TW', start_date='2015-01-01', end_date='2025-01-01'):
    """
    🔥 改进 1: 下载更多年份的数据
    台股代码格式: 1101.TW
    """
...
if __name__ == "__main__":
    print("🚀 改进版台股 3260 (威剛) 交易 AI 训练系统")
    print("=" * 70)
    # 配置
    TICKER = '3260.TWO'  # 台股 3260 威剛 (上櫃股票用 .TWO)
