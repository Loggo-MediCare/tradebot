...
TICKER = '3535.TW'
print(f"訓練 {TICKER} (晶彩科) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_3535_tw_model.pkl')
    print(f"\n模型已保存: xgb_3535_tw_model.pkl")
    ...
    with open('model_accuracy_3535_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('3535_TW_feature_importance.json', 'w', encoding='utf-8') as f:
