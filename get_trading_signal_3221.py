...
MODEL_FILE = 'xgb_3221_two_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 3221.TWO (台嘉碩) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 3221 台嘉碩 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('3221', '台嘉碩', max_results=5)