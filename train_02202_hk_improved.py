"""
改进版 02202.HK 股票交易 AI 训练 (Hong Kong)
"""
import os
...
def download_and_prepare_data(ticker='2202.HK', start_date='2015-01-01', end_date='2025-01-31'):
    print("=" * 70)
    ...
    try:
        ...
        print(f"   价格范围: HK${float(df['close'].min()):.2f} - HK${float(df['close'].max()):.2f}")
        return df
...
if __name__ == "__main__":
    print("🚀 改进版 02202.HK 交易 AI 训练系统 (Hong Kong)")
    print("=" * 70)
    TICKER = '2202.HK'
