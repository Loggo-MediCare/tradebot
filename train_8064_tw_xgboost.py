...
TICKER = '8064.TWO'
print(f"訓練 {TICKER} (東捷科技) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    joblib.dump(model, 'xgb_8064_two_model.pkl')
    print(f"\n模型已保存: xgb_8064_two_model.pkl")
    ...
    with open('model_accuracy_8064_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('8064_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
