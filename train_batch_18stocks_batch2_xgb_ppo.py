"""
XGBoost + PPO batch training — 18 TW Stocks (Batch 2)
4760 勤凱, 8291 尚茂, 3042 晶技, 6284 佳邦, 3485 敘豐, 6570 維田,
6207 齊科, 3026 禾伸堂, 6196 帆宣, 4927 泰鼎-KY, 6173 信昌電, 2464 盟立,
6274 台燿, 3236 千如, 6658 聯策, 2467 志聖, 6727 亞泰金屬, 3090 日電貿
"""
...
if __name__ == '__main__':
    print("=" * 72)
    print("  🚀 Batch XGBoost + PPO — 18 TW Stocks (Batch 2)")
