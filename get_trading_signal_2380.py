...
def get_trading_signal():
    ...
    print(f"🤖 2380.TW (虹光) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 2380 虹光 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('2380', '虹光', max_results=5)