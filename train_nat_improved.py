"""
改进版 NAT (Nordic American Tankers Ltd) 交易 AI 训练
=====================================
基于最佳模型 (AAPL Improved PPO) 客制化
改进点:
1. 更多训练数据 (2015-2025, 10年数据)
2. 改进的奖励函数 (鼓励交易)
3. 更长训练时间 (100,000 步)
4. 连续动作空间 (更灵活的买卖比例)
"""
...
# 2. 下载和处理数据
# ==========================================
def download_and_prepare_data(ticker='NAT', start_date='2015-01-01', end_date='2025-01-01'):
    """
    改进 1: 下载更多年份的数据
    NYSE股票: NAT (Nordic American Tankers Ltd)
    """
    print("=" * 70)
    print(f"下载 {ticker} 股票数据 (NYSE - Nordic American Tankers Ltd)...")
...
if __name__ == "__main__":
    print("改进版 NAT (Nordic American Tankers Ltd) 交易 AI 训练系统")
    print("=" * 70)
    # 配置
    TICKER = 'NAT'  # NYSE - Nordic American Tankers Ltd
    START_DATE = '2015-01-01'  # 从2015年开始 (10年数据)
    END_DATE = '2025-07-31'
    TRAIN_TEST_SPLIT = 0.8
    TOTAL_TIMESTEPS = 100000  # 训练100,000步
    print(f"目标股票: {TICKER} (Nordic American Tankers Ltd)")
