...
def main():
    ...
    try:
        ...
        print(f"🤖 {TICKER} (台塑化) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 6505 台塑化 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('6505', '台塑化', max_results=5)