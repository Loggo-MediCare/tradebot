...
def main():
    ...
    try:
        ...
        print(f"🤖 {TICKER} (欣雄) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 8908 欣雄 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('8908', '欣雄', max_results=5)