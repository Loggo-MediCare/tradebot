"""Batch train XGBoost + PPO for new TW/TWO stocks (batch 2)"""
...
STOCKS = [
    ('2327', '國巨',       '2015-01-01'),
    ('3624', '光頡',       '2015-01-01'),
    ('8455', '大拓-KY',    '2015-01-01'),
    ('8291', '尚茂',       '2015-01-01'),
    ('6924', '榮惠-KY',    '2020-01-01'),
    ('3577', '泓格',       '2015-01-01'),
    ('3055', '蔚華科',     '2015-01-01'),
    ('8374', '羅昇',       '2015-01-01'),
    ('7610', '聯友金屬',   '2018-01-01'),
    ('5215', '科嘉-KY',    '2015-01-01'),
    ('2359', '所羅門',     '2015-01-01'),
    ('3236', '千如',       '2015-01-01'),
    ('3691', '碩禾',       '2015-01-01'),
    ('8043', '蜜望實',     '2015-01-01'),
    ('7788', '兆川精密',   '2018-01-01'),
    ('3481', '群創',       '2015-01-01'),
    ('6204', '艾華',       '2015-01-01'),
    ('3024', '憶聲',       '2015-01-01'),
    ('3209', '全科',       '2015-01-01'),
    ('6432', '今展科',     '2015-01-01'),
    ('3609', '三一東林',   '2018-01-01'),
    ('6449', '鈺邦',       '2015-01-01'),
    ('6531', '愛普',       '2015-01-01'),
]
END_DATE        = '2026-05-01'
...
def train_stock(code, name, start_date):
    ...
    joblib.dump(xgb_model, f'xgb_{code}_{sfx.lower()}_model.pkl')
    ...
    ppo_model.save(f'ppo_{code}_{sfx.lower()}_improved')
...
if __name__ == '__main__':
    print("=" * 60)
    print(f"  BATCH TRAINING — {len(STOCKS)} TW Stocks")
    ...
    for r in sorted(results, key=lambda x: max(x['xgb_acc'], x['ppo_acc']), reverse=True):
        ...
        print(f"  {r['code']:<6} {r['name']:<10} {r['ticker']:<12} {r['xgb_acc']:>8.2f}% {r['ppo_acc']:>6.2f}% {r['winner']} {star}")
    print("  " + "-" * 58)
