"""台股 1326 (台化) — XGBoost 44.32% / PPO 27.14%"""
...
CODE='1326';TICKER='1326.TW';NAME='台化';XGB_ACC=44.32;PPO_ACC=27.14
...
def get_trading_signal():
    ...
    print(f"布林帶:{bbp:.1f}%  上軌NT${bbu:.2f} 下軌NT${bbl:.2f}  OBV:{'多頭'if obv>obvm else'空頭'}  量比:{vr:.2f}x")
