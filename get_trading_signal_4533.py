...
MODEL_FILE = 'xgb_4533_two_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (協易機) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 4533 協易機 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('4533', '協易機', max_results=5)