"""
CIEN (Ciena) Hybrid PPO + XGBoost 交易信號生成器
半導體設備龍頭股 - 準確度 62.99%
"""
import os
...
TICKER = 'CIEN'
MODEL_FILE = 'xgb_cien_model.pkl'
PPO_FILE   = 'ppo_cien_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Ciena) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    print("=" * 80)
    ...
    try:
        ...
        print(format_ppo_roi_line('CIEN', 'CIEN', 'ppo_cien_improved', df, ppo_action))
