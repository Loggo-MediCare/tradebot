...
TICKER = '4989.TW'
print(f"訓練 {TICKER} (榮科) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_4989_tw_model.pkl')
    print(f"\n模型已保存: xgb_4989_tw_model.pkl")
    ...
    with open('model_accuracy_4989_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('4989_TW_feature_importance.json', 'w', encoding='utf-8') as f:
