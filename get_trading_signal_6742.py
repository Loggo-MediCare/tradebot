"""
台股 6742 (VACTRONICS TECHNOLOGIES INC) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '6742.TW'
TICKER_NAME = 'VACTRONICS TECHNOLOGIES INC'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\6742.TW_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_6742_tw_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 6742.TW (VACTRONICS TECHNOLOGIES INC) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('6742.TW', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 VACTRONICS TECHNOLOGIES INC (6742.TW) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('6742.TW', 'VACTRONICS TECHNOLOGIES INC', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='6742_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (VACTRONICS TECHNOLOGIES INC)")
