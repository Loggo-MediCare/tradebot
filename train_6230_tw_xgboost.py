...
TICKER = '6230.TW'
print(f"訓練 {TICKER} (尼得科超眾) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_6230_tw_model.pkl')
    print(f"\n模型已保存: xgb_6230_tw_model.pkl")
    ...
    with open('model_accuracy_6230_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('6230_TW_feature_importance.json', 'w', encoding='utf-8') as f:
