...
MODEL_FILE = 'ppo_3135_tw_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (台灣) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 3135 台灣 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('3135', '台灣', max_results=5)