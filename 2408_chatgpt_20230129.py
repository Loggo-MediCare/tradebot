...
# Add current directory to sys.path to enable importing local modules
if os.getcwd() not in sys.path:
    sys.path.insert(0, os.getcwd())
    print(f"Added '{os.getcwd()}' to Python path for local modules.")


#!pip install stable-baselines3# !pip install FinBERT # Removed as it's not a directly installable package
...
def get_trading_signal():
    """生成今日交易信号"""
    print("=" * 80)
    print("🤖 台股 20260129 (chatgpt) AI 交易信号生成器")
    print("=" * 80)
    ...
    # 1. 加载模型
    model_path = r"ppo_2408_tw_improved"
    print(f"\n📦 加载 AI 模型: {model_path}")
