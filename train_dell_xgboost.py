"""
美股 DELL (Dell Technologies) XGBoost 交易模型訓練
"""
import os, sys, io
...
print("=" * 80)
print("🚀 美股 DELL (Dell Technologies) XGBoost 模型訓練")
print("=" * 80)
...
with open('model_accuracy_DELL.json', 'w', encoding='utf-8') as f:
