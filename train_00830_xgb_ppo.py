"""Train XGBoost + PPO for 00830 元大台灣ESG永續 (00830.TW)"""
...
CODE = '00830'; TICKER = '00830.TW'; NAME = '元大台灣ESG永續'
...
joblib.dump(xm, 'xgb_00830_tw_model.pkl')
...
json.dump(acc_data, open('model_accuracy_00830_TW.json',  'w', encoding='utf-8'), indent=2)
json.dump(acc_data, open('model_accuracy_00830.json', 'w', encoding='utf-8'), indent=2)
...
json.dump({'symbol': CODE, 'ticker': TICKER, 'model_type': 'PPO',
           ...
           'last_updated': datetime.now().strftime('%Y-%m-%d %H:%M:%S')},
          open('model_accuracy_00830_TW_ppo.json', 'w', encoding='utf-8'), indent=2)
