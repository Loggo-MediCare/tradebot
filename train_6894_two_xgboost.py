...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_6894_two_model.pkl')
    print(f"\n模型已保存: xgb_6894_two_model.pkl")
    ...
    with open('model_accuracy_6894_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('6894_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
