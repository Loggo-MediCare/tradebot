"""Train XGBoost + PPO for 2881 富邦金 (2881.TW)"""
...
joblib.dump(xm, 'xgb_2881_tw_model.pkl')
...
json.dump(acc_data, open('model_accuracy_2881.json',    'w', encoding='utf-8'), indent=2)
json.dump(acc_data, open('model_accuracy_2881_TW.json', 'w', encoding='utf-8'), indent=2)
...
json.dump({'symbol': CODE, 'ticker': TICKER, 'model_type': 'PPO',
           ...
           'last_updated': datetime.now().strftime('%Y-%m-%d %H:%M:%S')},
          open('model_accuracy_2881_TW_ppo.json', 'w', encoding='utf-8'), indent=2)
