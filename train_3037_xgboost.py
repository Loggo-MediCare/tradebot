...
TICKER = '3037.TW'
print(f"訓練 {TICKER} (欣興) XGBoost 模型")
print("=" * 80)
...
# 保存模型
joblib.dump(model, 'xgb_3037_tw_model.pkl')
print(f"\n模型已保存: xgb_3037_tw_model.pkl")
...
with open('model_accuracy_3037_TW.json', 'w', encoding='utf-8') as f:
...
with open('3037_TW_feature_importance.json', 'w', encoding='utf-8') as f:
