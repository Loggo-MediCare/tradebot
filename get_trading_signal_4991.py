...
4991.TWO (環宇-KY) XGBoost 交易信號生成器
...
MODEL_FILE = 'ppo_4991_two_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (環宇-KY) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 4991 環宇-KY 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('4991', '環宇-KY', max_results=5)