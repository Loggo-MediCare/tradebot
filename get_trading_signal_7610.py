"""
台股 7610 (LIANYOU METALS CO LTD) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '7610.TW'
TICKER_NAME = 'LIANYOU METALS CO LTD'
DQN_PATH    = r'c:\Users\Silvi\Projects\trading-bot\7610.TW_improved_anti_overfit_model.keras'
PPO_PATH    = r'c:\Users\Silvi\Projects\trading-bot\ppo_7610_tw_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 7610.TW (LIANYOU METALS CO LTD) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('7610.TW', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 LIANYOU METALS CO LTD (7610.TW) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('7610.TW', 'LIANYOU METALS CO LTD', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='7610_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (LIANYOU METALS CO LTD)")
