...
MODEL_FILE = 'ppo_1560_tw_improved'
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 1560 中砂 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('1560', '中砂', max_results=5)