"""
改进版 台股 3105 交易 AI 训练 (TWO Exchange)
=====================================
穩懋股份 (3105.TWO) - 台灣上櫃股票
改进点:
...
def download_and_prepare_data(ticker='3105.TWO', start_date='2015-01-01', end_date='2025-01-01'):
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    print(f"目标股票: {TICKER} (穩懋 - TWO Exchange)")
