...
TICKER = '6220.TWO'
print(f"訓練 {TICKER} (岳豐) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_6220_two_model.pkl')
    print(f"\n模型已保存: xgb_6220_two_model.pkl")
    ...
    with open('model_accuracy_6220_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('6220_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
