...
def get_trading_signal():
    ...
    try:
        ...
        df = yf.download('8450.TW', period='300d', progress=False, auto_adjust=True)  # 改为300天以计算200日均线
        ...
        try:
            ...
            ticker_info = yf.Ticker('8450.TW').info
    ...
    ai_muted = should_mute_ai_signal('8450.TW', threshold=52)
    ...
    try:
        ...
        profit_positive = evaluate_fundamentals_for_sell(yf, '8450.TW')['good']
    ...
    weight_calc = DynamicWeightCalculator('8450.TW')
    ...
    sentiment_result = calculate_sentiment_score('8450.TW', verbose=True)
...
# 加入爆发行情评分调整
        ...
        if bb_position < 35 and sell_score > 0:
            ...
            fundamentals = evaluate_fundamentals_for_sell(yf, '8450.TW')
        ...
        _growth = calculate_growth_score_adjustment(yf, '8450.TW')
