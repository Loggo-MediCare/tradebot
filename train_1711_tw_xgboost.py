...
TICKER = '1711.TW'
print(f"訓練 {TICKER} (永光) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_1711_tw_model.pkl')
    print(f"\n模型已保存: xgb_1711_tw_model.pkl")
    ...
    with open('model_accuracy_1711_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('1711_TW_feature_importance.json', 'w', encoding='utf-8') as f:
