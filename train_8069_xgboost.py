...
# 保存模型
model_file = 'xgb_8069_two_model.pkl'
...
with open('model_accuracy_8069_TWO.json', 'w', encoding='utf-8') as f:
...
with open('8069.TWO_feature_importance.json', 'w', encoding='utf-8') as f:
