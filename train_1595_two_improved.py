"""
改进版 台股 1595 交易 AI 训练 (TWO Exchange)
=====================================
川寶科技 (1595.TWO) - 台灣上櫃股票
改进点:
...
# 2. 下载和处理数据
# ==========================================
def download_and_prepare_data(ticker='1595.TWO', start_date='2015-01-01', end_date='2025-01-01'):
    """下载股票数据"""
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    print(f"目标股票: {TICKER} (川寶科技 - TWO Exchange)")
