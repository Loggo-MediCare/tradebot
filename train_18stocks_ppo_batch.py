"""
批量訓練 18 支股票 PPO 模型
京元電子, 健策, 光聖, 南亞科, 台光電, 台積電, 台達電, 奇鋐,
日月光, 旺矽, 欣興, 穎崴, 精測, 群聯, 聯發科, 華邦電, 貿聯-KY, 金像電
"""
import os
...
def train_stock(ticker, symbol, name):
    ...
    try:
        ...
        obs, _ = test_env.reset(); correct = 0; total = 0
...
if __name__ == '__main__':
    ...
    print(f"\n\n{'='*70}\n訓練完成摘要\n{'='*70}")
    print(f"{'代號':<10} {'名稱':<14} {'狀態':<4} {'準確度':>8} {'回報率':>10} {'判斷':>12}")
    print("-" * 62)
    for ticker, name, success, acc, ret in results:
        ...
        print(f"{ticker:<10} {name:<14} {status:<4} {acc_str:>8} {ret_str:>10}")
