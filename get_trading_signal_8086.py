...
MODEL_FILE = 'xgb_8086_two_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (宏捷科) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 8086 宏捷科 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('8086', '宏捷科', max_results=5)