...
MODEL_FILE = 'xgb_5011_two_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (久陽) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 5011 久陽 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('5011', '久陽', max_results=5)