...
TICKER = '3092.TW'
print(f"訓練 {TICKER} (鴻碩) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_3092_tw_model.pkl')
    print(f"\n模型已保存: xgb_3092_tw_model.pkl")
    ...
    with open('model_accuracy_3092_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('3092_TW_feature_importance.json', 'w', encoding='utf-8') as f:
