...
MODEL_FILE = 'ppo_6789_tw_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (采鈺) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 6789 采鈺 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('6789', '采鈺', max_results=5)