"""
美股 IBM (IBM Common Stock) XGBoost 交易模型訓練
"""
import os, sys, io
...
print("=" * 80)
print("🚀 美股 IBM (IBM Common Stock) XGBoost 模型訓練")
print("=" * 80)
...
with open('model_accuracy_IBM.json', 'w', encoding='utf-8') as f:
