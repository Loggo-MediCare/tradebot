...
6456.TW (GIS-KY) XGBoost 交易信號生成器
...
MODEL_FILE = 'xgb_6456_tw_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (GIS-KY) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 6456 6456 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('6456', '6456', max_results=5)