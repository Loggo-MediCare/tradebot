...
def get_trading_signal():
    ...
    model_filename = "ppo_1519_tw_improved"
    ...
    try:
        ...
        df = yf.download('1519.TW', period='300d', progress=False, auto_adjust=True)  # 改为300天以计算200日均线
    ...
    sentiment_result = calculate_sentiment_score('1519.TW', verbose=True)
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 1519 1519 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('1519', '1519', max_results=5)