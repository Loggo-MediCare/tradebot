"""
台股 6643 (M31 TECHNOLOGY CORPORATION) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '6643.TWO'
TICKER_NAME = 'M31 TECHNOLOGY CORPORATION'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\6643.TWO_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_6643_two_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 6643.TWO (M31 TECHNOLOGY CORPORATION) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('6643.TWO', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 M31 TECHNOLOGY CORPORATION (6643.TWO) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('6643.TWO', 'M31 TECHNOLOGY CORPORATION', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='6643_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (M31 TECHNOLOGY CORPORATION)")
