...
def get_trading_signal():
   ...
   # print(f("生成时间: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    ...
    model_path = r"ppo_3037_tw_improved"
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 3037_ppo_backup 3037_ppo_backup 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('3037_ppo_backup', '3037_ppo_backup', max_results=5)