...
MODEL_FILE = 'ppo_6146_two_improved'
...
def get_trading_signal():
    ...
    # ── Build PPO observation (15 features, matching TradingEnv._obs) ──
    ...
    buy_prob = action_val * 50 + 50   # [-1,1] → [0,100]%
    ...
    # ── Pattern analysis (influences final decision) ──
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 6146 耕興 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('6146', '耕興', max_results=5)