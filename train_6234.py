"""Train XGBoost + PPO for 6234.TWO (Tera Autotech)"""
...
print(f"Training {TICKER} (Tera Autotech 泰達電子)")
print("=" * 60)
...
joblib.dump(m,'xgb_6234_two_model.pkl')
with open('model_accuracy_6234_TWO.json','w',encoding='utf-8') as f:
...
ppo.save('ppo_6234_two_improved')
...
with open('model_accuracy_6234_TWO_ppo.json','w',encoding='utf-8') as f:
...
print(f"\n{'='*60}")
print(f"  6234.TWO (Tera Autotech) COMPARISON")
print(f"{'='*60}")
print(f"  XGBoost: {xgb_acc*100:.2f}%")
