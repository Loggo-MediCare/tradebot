...
TICKER = '3615.TWO'
print(f"訓練 {TICKER} (安可) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_3615_two_model.pkl')
    print(f"\n模型已保存: xgb_3615_two_model.pkl")
    ...
    with open('model_accuracy_3615_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('3615_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
