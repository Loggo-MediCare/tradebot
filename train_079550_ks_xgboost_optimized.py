"""
079550.KS (LIG Nex1) XGBoost 優化訓練
"""
import os
...
TICKER = '079550.KS'
print(f"優化訓練 {TICKER} (LIG Nex1) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    if test_acc > 0.514:  # Better than original 51.49%
        joblib.dump(model, 'xgb_079550_ks_model.pkl')
        print(f"\n✅ 模型已保存: xgb_079550_ks_model.pkl (準確度提升!)")
        ...
        with open('model_accuracy_079550_KS.json', 'w', encoding='utf-8') as f:
