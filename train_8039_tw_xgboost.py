...
TICKER = '8039.TW'
print(f"訓練 {TICKER} (台虹) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_8039_tw_model.pkl')
    print(f"\n模型已保存: xgb_8039_tw_model.pkl")
    ...
    with open('model_accuracy_8039_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('8039_TW_feature_importance.json', 'w', encoding='utf-8') as f:
