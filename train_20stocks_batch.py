"""
批量訓練 20 支台股 XGBoost + PPO
2330 台積電 / 2383 台光電 / 3046 建碁 / 5274 信驊 / 2454 聯發科
6515 穎崴 / 6223 旺矽 / 2368 金像電 / 3037 欣興 / 3665 貿聯-KY
3081 聯亞 / 3443 創意 / 2308 台達電 / 2360 致茂 / 6510 精測
"""
import os
...
STOCKS = [
    ...
    ('2383.TW',  '2383_TW',  '2383', '台光電'),
    ('3046.TW',  '3046_TW',  '3046', '建碁'),
    ('5274.TW',  '5274_TW',  '5274', '信驊'),
    ('2454.TW',  '2454_TW',  '2454', '聯發科'),
    ('6515.TW',  '6515_TW',  '6515', '穎崴'),
    ('6223.TWO', '6223_TWO', '6223', '旺矽'),
    ('2368.TW',  '2368_TW',  '2368', '金像電'),
    ('3037.TW',  '3037_TW',  '3037', '欣興'),
    ('3665.TW',  '3665_TW',  '3665', '貿聯-KY'),
    ('3081.TWO', '3081_TWO', '3081', '聯亞'),
    ('3443.TW',  '3443_TW',  '3443', '創意'),
    ('2308.TW',  '2308_TW',  '2308', '台達電'),
    ('2360.TW',  '2360_TW',  '2360', '致茂'),
    ('6510.TWO', '6510_TWO', '6510', '精測'),
]
...
def train_stock(ticker, sym_xgb, sym_ppo, name):
    ...
    try:
        ...
        dc = df_xgb.dropna(subset=FEATURE_COLUMNS + ['target'])
        ...
        with open(f'{sym_xgb}_feature_importance.json', 'w', encoding='utf-8') as f:
            json.dump({'ticker': ticker, 'model_type': 'XGBoost', 'model_accuracy': float(xgb_acc),
                       'feature_importance': {r['feature']: float(r['importance']) for _, r in fi.iterrows()}},
                      f, ensure_ascii=False, indent=2)
    ...
    try:
        ...
        df_ppo = df_ppo.bfill().ffill(); dc_ppo = df_ppo.dropna()
