...
print("=" * 80)
print("🚀 台股 3004 豐達科 XGBoost 模型訓練")
print("=" * 80)
...
# 保存模型
model_file = 'xgb_3004_tw_model.pkl'
...
with open('model_accuracy_3004_TW.json', 'w', encoding='utf-8') as f:
...
with open('3004.TW_feature_importance.json', 'w', encoding='utf-8') as f:
