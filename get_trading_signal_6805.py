...
def get_trading_signal():
    ...
    model_filename = "ppo_6805_tw_improved"
    ...
    try:
        ...
        df = yf.download('6805.TW', period='300d', progress=False, auto_adjust=True)  # 改为300天以计算200日均线
    ...
    ai_muted = should_mute_ai_signal('6805.TW', threshold=52)
    ...
    try:
        ...
        profit_positive = evaluate_fundamentals_for_sell(yf, '6805.TW')['good']
    ...
    sentiment_result = calculate_sentiment_score('6805.TW', verbose=True)
...
# 加入爆发行情评分调整
        ...
        if bb_position < 35 and sell_score > 0:
            ...
            fundamentals = evaluate_fundamentals_for_sell(yf, '6805.TW')
        ...
        _growth = calculate_growth_score_adjustment(yf, '6805.TW')
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 6805 6805 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('6805', '6805', max_results=5)