...
def download_and_prepare_data(ticker='2357.TW', start_date='2015-01-01', end_date='2025-01-31'):
    print("=" * 70)
...
if __name__ == "__main__":
    print("🚀 改进版 2357.TW 交易 AI 训练系统 (Taiwan)")
    print("=" * 70)
    TICKER = '2357.TW'
