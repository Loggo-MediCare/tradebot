...
def download_and_prepare_data(ticker='6446.TW', start_date='2015-01-01', end_date='2025-01-31'):
    print("=" * 70)
...
if __name__ == "__main__":
    print("🚀 改进版 6446.TW 交易 AI 训练系统 (Taiwan)")
    print("=" * 70)
    TICKER = '6446.TW'
