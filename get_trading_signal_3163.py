...
3163.TWO (Browave Corporation) XGBoost 交易信號生成器
...
MODEL_FILE = 'ppo_3163_two_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Browave Corporation) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 3163 3163 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('3163', '3163', max_results=5)