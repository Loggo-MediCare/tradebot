...
def get_trading_signal():
    ...
    # 顯示AI模型準確度
    accuracy_display = get_model_accuracy_display('3050.TW')
    print(f"模型準確度: {accuracy_display}")
    print("=" * 80)

    # 1. 加载模型
    model_path = r"C:\Users\Silvi\Projects\trading-bot\ppo_3050_tw_improved"
    print(f"\n📦 加载 AI 模型: {model_path}")
...
if __name__ == "__main__":
    ...
    if result:
        ...
        # 顯示AI模型準確度摘要
        print(f"   {get_model_accuracy_display('3050.TW')}")
    else:
        print("\n❌ 信号生成失败")
