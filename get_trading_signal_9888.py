...
TICKER = '9888.HK'
MODEL_PATH = r"C:\Users\Silvi\Projects\trading-bot\ppo_9888_hk_improved"
...
def get_trading_signal():
    ...
    sentiment_result = calculate_sentiment_score('9888.HK', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 9888.HK (9888.HK) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('9888.HK', '9888.HK', max_results=5)
    print("\n" + "=" * 60)
