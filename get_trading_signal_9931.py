...
def main():
    ...
    try:
        ...
        print(f"🤖 {TICKER} (欣高) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 9931 欣高 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('9931', '欣高', max_results=5)