...
TICKER = '3491.TWO'
MODEL_PATH = r"C:\Users\Silvi\Projects\trading-bot\ppo_3491_two_improved"
...
def get_trading_signal():
    ...
    sentiment_result = calculate_sentiment_score('3491.TWO', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 3491.TWO (3491.TWO) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('3491.TWO', '3491.TWO', max_results=5)
    print("\n" + "=" * 60)
