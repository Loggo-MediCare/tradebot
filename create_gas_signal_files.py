...
STOCKS = [
    {'code': '1314', 'ticker': '1314.TW', 'name': '中石化', 'accuracy': 86.92},
    {'code': '8908', 'ticker': '8908.TWO', 'name': '欣雄', 'accuracy': 95.58},
    {'code': '9931', 'ticker': '9931.TW', 'name': '欣高', 'accuracy': 98.90},
    {'code': '8917', 'ticker': '8917.TWO', 'name': '欣泰', 'accuracy': 96.32},
    {'code': '6505', 'ticker': '6505.TW', 'name': '台塑化', 'accuracy': 70.17},
    {'code': '9918', 'ticker': '9918.TW', 'name': '欣天然', 'accuracy': 99.08},
]
...
for stock in STOCKS:
    filename = f"get_trading_signal_{stock['code']}.py"
