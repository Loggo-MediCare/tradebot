"""
美股 JAZZ (Jazz Pharmaceuticals) XGBoost 交易模型訓練
"""
import os
...
print("="*80)
print("訓練 JAZZ (Jazz Pharmaceuticals) XGBoost 模型")
print("="*80)
...
# 9. 保存模型
model_filename = 'xgb_jazz_model.pkl'
...
print(f"準確度數據已更新: model_accuracy_JAZZ.json")
...
with open('JAZZ_feature_importance.json', 'w', encoding='utf-8') as f:
    json.dump(feature_importance_data, f, ensure_ascii=False, indent=2)

print(f"特徵重要性已保存: JAZZ_feature_importance.json")
