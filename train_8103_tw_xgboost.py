"""
改进版 台股 8103 交易 AI 训练 (XGBoost模型)
=====================================
瀚荃股份 (8103.TW) - 高科技公司
改进点:
...
# 2. 下载和处理数据
# ==========================================
def download_and_prepare_data(ticker='8103.TW', start_date='2015-01-01', end_date='2025-01-01'):
    """下载股票数据"""
    print("=" * 70)
