"""
台股 1595 (CHIME BALL TECHNOLOGY CO LTD) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '1595.TWO'
TICKER_NAME = 'CHIME BALL TECHNOLOGY CO LTD'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\1595.TWO_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_1595_two_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 1595.TWO (CHIME BALL TECHNOLOGY CO LTD) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('1595.TWO', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 CHIME BALL TECHNOLOGY CO LTD (1595.TWO) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('1595.TWO', 'CHIME BALL TECHNOLOGY CO LTD', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='1595_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (CHIME BALL TECHNOLOGY CO LTD)")
