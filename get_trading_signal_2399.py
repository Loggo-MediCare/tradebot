...
MODEL_FILE = 'xgb_2399_tw_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (映泰) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 2399 映泰 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('2399', '映泰', max_results=5)