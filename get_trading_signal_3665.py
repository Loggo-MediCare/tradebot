...
MODEL_FILE = 'ppo_3665_tw_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (貿聯-KY) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 3665 貿聯-KY 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('3665', '貿聯-KY', max_results=5)