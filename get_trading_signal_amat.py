"""
AMAT (Applied Materials 應用材料) Hybrid PPO + XGBoost 交易信號生成器
半導體設備龍頭股 - 準確度 69.73%
"""
import os
...
TICKER = 'AMAT'
MODEL_FILE = 'xgb_amat_model.pkl'
PPO_FILE   = 'ppo_amat_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Applied Materials) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    print("=" * 80)
    ...
    try:
        ...
        print(format_ppo_roi_line('AMAT', 'AMAT', 'ppo_amat_improved', df, ppo_action))
