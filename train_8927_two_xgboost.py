...
TICKER = '8927.TWO'
print(f"訓練 {TICKER} (北基) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_8927_two_model.pkl')
    print(f"\n模型已保存: xgb_8927_two_model.pkl")
    ...
    with open('model_accuracy_8927_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('8927_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
