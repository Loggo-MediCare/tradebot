"""
改进版 HTGC (Hercules Capital Inc) 交易 AI 训练
=====================================
...
# 2. 下载和处理数据
# ==========================================
def download_and_prepare_data(ticker='HTGC', start_date='2015-01-01', end_date='2025-01-01'):
    """
    改进 1: 下载更多年份的数据
    NYSE股票: HTGC (Hercules Capital Inc)
    """
    print("=" * 70)
    print(f"下载 {ticker} 股票数据 (NYSE - Hercules Capital Inc)...")
...
if __name__ == "__main__":
    print("改进版 HTGC (Hercules Capital Inc) 交易 AI 训练系统")
    print("=" * 70)
    # 配置
    TICKER = 'HTGC'  # NYSE - Hercules Capital Inc
    START_DATE = '2015-01-01'  # 从2015年开始 (10年数据)
    END_DATE = '2025-07-31'
    TRAIN_TEST_SPLIT = 0.8
    TOTAL_TIMESTEPS = 100000  # 训练100,000步
    print(f"目标股票: {TICKER} (Hercules Capital Inc)")
