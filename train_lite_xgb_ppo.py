"""Train XGBoost + PPO for LITE (Lumentum Holdings) with comparison"""
...
print(f"Training {TICKER} (Lumentum Holdings) — XGBoost + PPO")
print("=" * 60)
...
joblib.dump(m,'xgb_lite_model.pkl')
...
with open('model_accuracy_LITE_ppo.json','w',encoding='utf-8') as f:
...
print(f"\n{'='*60}")
print(f"  LITE (Lumentum Holdings) COMPARISON")
print(f"{'='*60}")
print(f"  XGBoost: {xgb_acc*100:.2f}%")
