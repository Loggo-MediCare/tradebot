...
def get_trading_signal():
   ...
   # print(f("生成时间: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    ...
    model_path = r"ppo_2408_bak_tw_improved"
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 2408_bak 2408_bak 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('2408_bak', '2408_bak', max_results=5)