"""Train XGBoost + PPO for 3017 奇鋐 (3017.TW)"""
...
joblib.dump(xgb_model, 'xgb_3017_tw_model.pkl')
with open('model_accuracy_3017_TW.json', 'w', encoding='utf-8') as f:
...
ppo_model.save('ppo_3017_tw_improved')
...
with open('model_accuracy_3017_TW_ppo.json', 'w', encoding='utf-8') as f:
...
==============================
  ...
  PPO:     {ppo_acc*100:.2f}%
  Winner:  {winner}
  Diff:    {abs(xgb_acc-ppo_acc)*100:.2f}%
==============================""")
