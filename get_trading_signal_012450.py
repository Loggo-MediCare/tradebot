...
012450.KS (Hanwha Aerospace Co Ltd) XGBoost 交易信號生成器
...
MODEL_FILE = 'xgb_012450_ks_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Hanwha Aerospace) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 012450 012450 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('012450', '012450', max_results=5)