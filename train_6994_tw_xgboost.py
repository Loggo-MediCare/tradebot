...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_6994_tw_model.pkl')
    print(f"\n模型已保存: xgb_6994_tw_model.pkl")
    ...
    with open('model_accuracy_6994_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('6994_TW_feature_importance.json', 'w', encoding='utf-8') as f:
