"""
台股 6834 (6834.TW) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '6834.TW'
TICKER_NAME = '6834.TW'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\6834.TW_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_6834_tw_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 6834.TW (6834.TW) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('6834.TW', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 6834.TW (6834.TW) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('6834.TW', '6834.TW', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='6834_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (6834.TW)")
