"""
079550.KS (LIG Nex1 Co Ltd) XGBoost 訓練
"""
import os
...
TICKER = '079550.KS'
print(f"訓練 {TICKER} (LIG Nex1 Co Ltd) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    with open('079550_KS_feature_importance.json', 'w', encoding='utf-8') as f:
