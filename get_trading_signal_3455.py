...
MODEL_FILE = 'ppo_3455_two_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (由田) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 3455 由田 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('3455', '由田', max_results=5)