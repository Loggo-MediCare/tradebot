"""
9984.T (SoftBank Group) XGBoost 訓練
"""
import os
...
TICKER = '9984.T'
print(f"訓練 {TICKER} (SoftBank Group) XGBoost 模型")
print("=" * 80)
...
# 保存模型
joblib.dump(model, 'xgb_9984_t_model.pkl')
print(f"\n模型已保存: xgb_9984_t_model.pkl")
...
with open('model_accuracy_9984_T.json', 'w', encoding='utf-8') as f:
...
with open('9984_T_feature_importance.json', 'w', encoding='utf-8') as f:
