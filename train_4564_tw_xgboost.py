...
TICKER = '4564.TW'
print(f"訓練 {TICKER} (元翎) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_4564_tw_model.pkl')
    print(f"\n模型已保存: xgb_4564_tw_model.pkl")
    ...
    with open('model_accuracy_4564_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('4564_TW_feature_importance.json', 'w', encoding='utf-8') as f:
