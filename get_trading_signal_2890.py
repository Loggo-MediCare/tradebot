"""台股 2890 (永豐金) — XGBoost 75.68% / PPO 25.32%"""
...
CODE='2890';TICKER='2890.TW';NAME='永豐金';XGB_ACC=75.68;PPO_ACC=25.32
...
def get_trading_signal():
    ...
    print("\n"+"="*80+f"\n🧠XGBoost({XGB_ACC:.2f}%) + 🤖PPO({PPO_ACC:.2f}%) [主用XGBoost]\n"+"="*80)
    xgb_prob=None
    try:
    ...
    try:
        ...
        if should_mute_ai_signal(TICKER,threshold=52):ppo_action=0.;print("⚠️PPO靜音(準確度低)")
