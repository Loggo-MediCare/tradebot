...
MODEL_FILE = 'xgb_8039_tw_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (台虹) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 8039 台虹 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('8039', '台虹', max_results=5)