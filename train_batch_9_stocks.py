...
STOCKS_TO_TRAIN = [
    '6285.TW', '4561.TW', '2489.TW', '3149.TW', '8046.TW',
    '7777.TW', '4540.TW', '6435.TW', '6492.TW', '4563.TW',
    '1514.TW', '6470.TW', '6423.TW', '1471.TW', '3037.TW',
    '6548.TW', '3051.TW', '4127.TW', '7788.TW', '6510.TW',
    '6415.TW', '3631.TW', '1529.TW', '4534.TW', '6988.TW',
    '2313.TW', '2367.TW', '3234.TW', '1802.TW', '3338.TW',
    '6271.TW', '4939.TW', '8438.TW', '3016.TW', '3491.TW',
]
...
if __name__ == "__main__":
    print("=" * 50)
    print(f"🚀 批量训练第9批 ({len(STOCKS_TO_TRAIN)} stocks)")
    print("=" * 50)
    ok, fail = 0, []
    for i, t in enumerate(STOCKS_TO_TRAIN, 1):
        print(f"[{i}/{len(STOCKS_TO_TRAIN)}]", end=" ")
        df = download(t)
        ...
        ok += 1
    print(f"\n{'='*50}")
    print(f"✅ {ok}/{len(STOCKS_TO_TRAIN)}")
