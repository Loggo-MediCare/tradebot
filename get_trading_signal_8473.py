"""
台股 8473 (FOREST WATER ENVIRONMENTAL ENG') AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '8473.TW'
TICKER_NAME = 'FOREST WATER ENVIRONMENTAL ENG'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\8473.TW_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_8473_tw_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 8473.TW (FOREST WATER ENVIRONMENTAL ENG') 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('8473.TW', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 FOREST WATER ENVIRONMENTAL ENG (8473.TW) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('8473.TW', 'FOREST WATER ENVIRONMENTAL ENG', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='8473_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (FOREST WATER ENVIRONMENTAL ENG')")
