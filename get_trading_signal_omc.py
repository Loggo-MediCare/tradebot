"""
OMC (Omnicom) Hybrid PPO + XGBoost 交易信號生成器
半導體設備龍頭股 - 準確度 88.79%
"""
import os
...
TICKER = 'OMC'
MODEL_FILE = 'xgb_omc_model.pkl'
PPO_FILE   = 'ppo_omc_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Omnicom) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    print("=" * 80)
    ...
    try:
        ...
        print(format_ppo_roi_line('OMC', 'OMC', 'ppo_omc_improved', df, ppo_action))
