...
TICKER = '2485.TW'
print(f"訓練 {TICKER} (兆赫) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_2485_tw_model.pkl')
    print(f"\n模型已保存: xgb_2485_tw_model.pkl")
    ...
    with open('model_accuracy_2485_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('2485_TW_feature_importance.json', 'w', encoding='utf-8') as f:
