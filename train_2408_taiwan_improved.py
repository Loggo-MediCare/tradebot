...
import sys
import io
# 移除以下這行，因為 sys.stdout 在 Colab 中可能不具有 .buffer 屬性，且通常不需要手動重新配置編碼。
...
# 2. 下载和处理数据
# ==========================================
def download_and_prepare_data(ticker='2408.TW', start_date='2015-01-01', end_date='2025-01-01'):
#def download_and_prepare_data(ticker='6209.TW', start_date='2015-01-01', end_date='2024-01-01'):
    ...
    """
    print("=" * 70)
    print(f"下载 {ticker} 股票数据 (台股 南亞科技)...")
...
if __name__ == "__main__":
    print("🚀 改进版台股 2408 (南亞科技) 交易 AI 训练系统")
    print("=" * 70)
    # 配置
    TICKER = '2408.TW'  # 台股 南亞科技
    # 配置
    # TICKER = '6209.TW'  # 台股 南亞科技
    START_DATE = '2015-01-01'  #  从2015年开始 (9年数据)
    END_DATE = '2025-07-31'
    TRAIN_TEST_SPLIT = 0.8
    TOTAL_TIMESTEPS = 100000  #  训练100,000步
    print(f"目标股票: {TICKER} (南亞科技)")
