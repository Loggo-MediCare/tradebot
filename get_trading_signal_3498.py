...
MODEL_FILE = 'xgb_3498_two_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (陽程) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 3498 陽程 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('3498', '陽程', max_results=5)