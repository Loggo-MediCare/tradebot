...
TICKER = '5011.TWO'
print(f"訓練 {TICKER} (久陽) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_5011_two_model.pkl')
    print(f"\n模型已保存: xgb_5011_two_model.pkl")
    ...
    with open('model_accuracy_5011_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('5011_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
