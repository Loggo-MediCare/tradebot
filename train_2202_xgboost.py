...
TICKER = '2202.HK'
print(f"訓練 {TICKER} (萬科企業 Vanke) XGBoost 模型")
print("=" * 80)
...
# 保存模型
joblib.dump(model, 'xgb_2202_hk_model.pkl')
print(f"\n模型已保存: xgb_2202_hk_model.pkl")
...
with open('model_accuracy_2202_HK.json', 'w', encoding='utf-8') as f:
...
with open('2202_HK_feature_importance.json', 'w', encoding='utf-8') as f:
