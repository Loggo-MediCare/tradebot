...
# 股票列表
STOCKS = [
    {'code': '4938.TW', 'name': '和碩', 'file': '4938'},
    {'code': '6443.TW', 'name': '元晶', 'file': '6443'},
    {'code': '6209.TW', 'name': '今國光', 'file': '6209'},
    {'code': '2449.TW', 'name': '京元電子', 'file': '2449'},
    {'code': '5498.TW', 'name': '凱崴', 'file': '5498'},
    {'code': '3017.TW', 'name': '奇鋐', 'file': '3017'},
    {'code': '6805.TW', 'name': '富世達', 'file': '6805'},
    {'code': '8210.TW', 'name': '勤誠', 'file': '8210'},
]
...
def train_stock(stock_code, stock_name, file_code):
    ...
    # 5. 保存模型
    model_path = f"ppo_{file_code}_tw_improved.zip"
