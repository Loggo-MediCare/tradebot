...
def get_trading_signal():
    ...
    accuracy_display = get_model_accuracy_display('2313.TW')
    ...
    model_filename = "ppo_2313_tw_improved"
    ...
    try:
        ...
        df = yf.download('2313.TW', period='300d', progress=False, auto_adjust=True)  # 改为300天以计算200日均线
        ...
        try:
            ...
            ticker_info = yf.Ticker('2313.TW').info
    ...
    ai_muted = should_mute_ai_signal('2313.TW', threshold=52)
    ...
    try:
        ...
        profit_positive = evaluate_fundamentals_for_sell(yf, '2313.TW')['good']
    ...
    weight_calc = DynamicWeightCalculator('2313.TW')
    ...
    sentiment_result = calculate_sentiment_score('2313.TW', verbose=True)
...
# 加入爆发行情评分调整
        ...
        if bb_position < 35 and sell_score > 0:
            ...
            fundamentals = evaluate_fundamentals_for_sell(yf, '2313.TW')
        ...
        _growth = calculate_growth_score_adjustment(yf, '2313.TW')
...
if __name__ == "__main__":
    ...
    if result:
        ...
        print(f"   {get_model_accuracy_display('2313.TW')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 2313 2313 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('2313', '2313', max_results=5)