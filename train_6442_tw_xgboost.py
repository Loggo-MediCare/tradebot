...
TICKER = '6442.TW'
print(f"訓練 {TICKER} (光聖) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_6442_tw_model.pkl')
    print(f"\n模型已保存: xgb_6442_tw_model.pkl")
    ...
    with open('model_accuracy_6442_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('6442_TW_feature_importance.json', 'w', encoding='utf-8') as f:
