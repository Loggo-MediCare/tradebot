"""
GPN (Global Payments) Hybrid PPO + XGBoost 交易信號生成器
半導體設備龍頭股 - 準確度 80.07%
"""
import os
...
TICKER = 'GPN'
MODEL_FILE = 'xgb_gpn_model.pkl'
PPO_FILE   = 'ppo_gpn_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Global Payments) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    print("=" * 80)
    ...
    try:
        ...
        print(format_ppo_roi_line('GPN', 'GPN', 'ppo_gpn_improved', df, ppo_action))
