"""
台股 8291 (SHINEMORE TECHNOLOGY MATERIALS ) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '8291.TWO'
TICKER_NAME = 'SHINEMORE TECHNOLOGY MATERIALS '
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\8291.TWO_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_8291_two_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 8291.TWO (SHINEMORE TECHNOLOGY MATERIALS ) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('8291.TWO', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 SHINEMORE TECHNOLOGY MATERIALS  (8291.TWO) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('8291.TWO', 'SHINEMORE TECHNOLOGY MATERIALS ', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='8291_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (SHINEMORE TECHNOLOGY MATERIALS )")
