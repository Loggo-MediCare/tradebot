...
def download_and_prepare_data(ticker='3576.TW', start_date='2015-01-01', end_date='2025-12-31'):
    print("=" * 70)
...
def analyze_feature_importance(df, ticker):
    ...
    print(f"特徵重要性已保存: {json_filename}")
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 70)
    print("训练完成!")
    print(f"模型文件: ppo_3576_tw_improved.zip")
    print("=" * 70)
