...
MODEL_FILE = 'xgb_6530_two_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 6530.TWO (創威) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 6530 創威 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('6530', '創威', max_results=5)