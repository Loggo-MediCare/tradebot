...
TICKER = 'NVDA'
print(f"優化訓練 {TICKER} (NVIDIA) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_nvda_model.pkl')
    print(f"\n✅ 模型已保存: xgb_nvda_model.pkl")
    ...
    with open('model_accuracy_NVDA.json', 'w', encoding='utf-8') as f:
