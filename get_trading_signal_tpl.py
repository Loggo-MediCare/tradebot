"""
TPL (Texas Pacific Land) Hybrid PPO + XGBoost 交易信號生成器
半導體設備龍頭股 - 準確度 71.71%
"""
import os
...
TICKER = 'TPL'
MODEL_FILE = 'xgb_tpl_model.pkl'
PPO_FILE   = 'ppo_tpl_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Texas Pacific Land) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    print("=" * 80)
    ...
    try:
        ...
        print(format_ppo_roi_line('TPL', 'TPL', 'ppo_tpl_improved', df, ppo_action))
