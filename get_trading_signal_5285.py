"""
台股 5285 (JIH LIN TECHNOLOGY CO LTD) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '5285.TW'
TICKER_NAME = 'JIH LIN TECHNOLOGY CO LTD'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\5285.TW_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_5285_tw_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 5285.TW (JIH LIN TECHNOLOGY CO LTD) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('5285.TW', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 JIH LIN TECHNOLOGY CO LTD (5285.TW) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('5285.TW', 'JIH LIN TECHNOLOGY CO LTD', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='5285_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (JIH LIN TECHNOLOGY CO LTD)")
