"""
AMAT (Applied Materials 應用材料) XGBoost 優化訓練
半導體設備龍頭股
"""
import os
...
TICKER = 'AMAT'
print(f"優化訓練 {TICKER} (Applied Materials) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_amat_model.pkl')
    print(f"\n✅ 模型已保存: xgb_amat_model.pkl")
    ...
    with open('model_accuracy_AMAT.json', 'w', encoding='utf-8') as f:
