...
TICKER = '3234.TWO'
print(f"訓練 {TICKER} (光環) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_3234_two_model.pkl')
    print(f"\n模型已保存: xgb_3234_two_model.pkl")
    ...
    with open('model_accuracy_3234_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('3234_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
