...
MODEL_FILE = 'ppo_6187_two_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (環球晶) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 6187 環球晶 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('6187', '環球晶', max_results=5)