"""Train XGBoost + PPO for 7734.TWO (印能科技)"""
...
joblib.dump(m,'xgb_7734_two_model.pkl')
...
ppo.save('ppo_7734_two_improved')
...
with open('model_accuracy_7734_TWO_ppo.json','w',encoding='utf-8') as f:
...
print(f"\n{'='*60}")
print(f"  7734.TWO (印能科技) COMPARISON")
print(f"{'='*60}")
print(f"  XGBoost: {xgb_acc*100:.2f}%")
