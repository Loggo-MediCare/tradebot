...
TICKER = '8131.TAIWAN'
MODEL_PATH = r"C:\Users\Silvi\Projects\trading-bot\ppo_8131_taiwan_improved"
...
def get_trading_signal():
    ...
    sentiment_result = calculate_sentiment_score('8131.TAIWAN', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 8131.TAIWAN (8131.TAIWAN) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('8131.TAIWAN', '8131.TAIWAN', max_results=5)
    print("\n" + "=" * 60)
