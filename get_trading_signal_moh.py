"""
MOH (Molina Healthcare) Hybrid PPO + XGBoost 交易信號生成器
半導體設備龍頭股 - 準確度 72.78%
"""
import os
...
TICKER = 'MOH'
MODEL_FILE = 'xgb_moh_model.pkl'
PPO_FILE   = 'ppo_moh_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Molina Healthcare) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    print("=" * 80)
    ...
    try:
        ...
        print(format_ppo_roi_line('MOH', 'MOH', 'ppo_moh_improved', df, ppo_action))
