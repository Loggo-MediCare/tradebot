...
def try_download_stock(ticker, code):
...
def main():
    ...
    # 下載數據
    print("\n下載 8021.TW 歷史數據...")
    df, actual_ticker = try_download_stock('8021.TW', '8021')
    ...
    with open('model_accuracy_8021.json', 'w', encoding='utf-8') as f:
