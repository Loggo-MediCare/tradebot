...
def main():
    ...
    try:
        ...
        print(f"🤖 {TICKER} (欣天然) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 9918 欣天然 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('9918', '欣天然', max_results=5)