...
MODEL_FILE = 'ppo_2485_tw_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (兆赫) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 2485 兆赫 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('2485', '兆赫', max_results=5)