"""
012450.KS (Hanwha Aerospace Co Ltd) XGBoost 訓練
"""
import os
...
TICKER = '012450.KS'
print(f"訓練 {TICKER} (Hanwha Aerospace Co Ltd) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_012450_ks_model.pkl')
    print(f"\n模型已保存: xgb_012450_ks_model.pkl")
    ...
    with open('model_accuracy_012450_KS.json', 'w', encoding='utf-8') as f:
    ...
    with open('012450_KS_feature_importance.json', 'w', encoding='utf-8') as f:
