...
def get_trading_signal():
    ...
    accuracy_display = get_model_accuracy_display('6423.TWO')
    ...
    model_path = r"C:\Users\Silvi\Projects\trading-bot\ppo_6423_tw_improved"
    ...
    try:
        ...
        df = yf.download('6423.TWO', period='2y', progress=False, auto_adjust=True)
        ...
        try:
            ...
            ticker_info = yf.Ticker('6423.TWO').info
    ...
    weight_calc = DynamicWeightCalculator('6423.TWO')
    ...
    sentiment_result = calculate_sentiment_score('6423.TWO', verbose=False)
    ...
    if action_value > 0.1:
        ...
        buy_score, signal_override, buy_reasons, buy_warnings, buy_metadata, sentiment_result = \
            calculate_enhanced_buy_score_with_sentiment(
                ...
                ai_action=action_value, buy_weights=buy_weights, symbol='6423.TWO'
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            chart_df = yf.Ticker("6423.TWO").history(period="6mo")


            chart_df.columns = [c.lower() for c in chart_df.columns]


            chart_path = "6423_chart.png"


            plot_candlestick(chart_df, "6423.TWO", save_path=chart_path)
        ...
        print(f"   {get_model_accuracy_display('6423.TWO')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 6423 精測 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('6423', '精測', max_results=5)