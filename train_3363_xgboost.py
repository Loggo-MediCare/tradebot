...
print("=" * 80)
print("🚀 台股 3363 上詮 XGBoost 模型訓練")
print("=" * 80)

# 下載數據 (OTC 櫃買市場 - 使用 .TWO)
TICKER = '3363.TWO'
...
# 保存模型 (OTC 使用 TWO)
model_file = 'xgb_3363_two_model.pkl'
...
with open('model_accuracy_3363_TWO.json', 'w', encoding='utf-8') as f:
...
with open('3363.TWO_feature_importance.json', 'w', encoding='utf-8') as f:
