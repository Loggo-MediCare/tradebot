...
TICKER = '4577.TWO'
print(f"訓練 {TICKER} (達航科技) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_4577_two_model.pkl')
    print(f"\n模型已保存: xgb_4577_two_model.pkl")
    ...
    with open('model_accuracy_4577_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('4577_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
