...
stocks = [
    ('2467.TW', '钜祥 C Sun Mfg'),
    ('3030.TW', '德律 Test Research'),
    ('3092.TW', '鴻碩 Hotron Precision'),
    ('3221.TWO', '台嘉碩 Tai-Saw Technology'),
    ('3234.TWO', '光環 TrueLight'),
    ('3535.TW', '晶彩科 Favite'),
]
...
print(f"\n完成! 狀態: {{'✅ 達標' if test_acc >= 0.58 else '⚠️  未達標 (但可用)' if test_acc >= 0.50 else '❌ 未達標'}}")
'''
...
print(f'\n✅ Created {len(stocks)} training scripts')
