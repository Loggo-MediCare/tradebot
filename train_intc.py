"""Train XGBoost + PPO for INTC (Intel)"""
...
print(f"Training {TICKER} (Intel Corporation) — XGBoost + PPO")
print("=" * 60)
...
joblib.dump(m,'xgb_intc_model.pkl')
with open('model_accuracy_INTC.json','w',encoding='utf-8') as f:
...
ppo.learn(total_timesteps=100000); ppo.save('ppo_intc_improved')
...
with open('model_accuracy_INTC_ppo.json','w',encoding='utf-8') as f:
