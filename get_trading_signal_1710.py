"""
台股 1710 (ORIENTAL UNION CHEMICAL CORP) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '1710.TW'
TICKER_NAME = 'ORIENTAL UNION CHEMICAL CORP'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\1710.TW_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_1710_tw_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 1710.TW (ORIENTAL UNION CHEMICAL CORP) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('1710.TW', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 ORIENTAL UNION CHEMICAL CORP (1710.TW) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('1710.TW', 'ORIENTAL UNION CHEMICAL CORP', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='1710_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (ORIENTAL UNION CHEMICAL CORP)")
