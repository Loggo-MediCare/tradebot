...
# axes[0].plot(futures_data.index, futures_data['MA_200'], label='MA 200', color='purple', linewidth=2, linestyle='--', alpha=0.5) # 新增 MA200
...
print(f"\n🤖 系統建議:")
if curr_signal_type == 'REVERSAL':
    print("   【反轉買入】- 長期築底信號，需確認股價已突破盤整區，建議分批進場")
elif curr_signal_type == 'TREND':
    print("   【順勢買入】- 長期趨勢確立 (MA200之上)，高品質回檔買點，可追蹤進場")
elif curr_signal_type == 'BREAKOUT':
    print("   【突破買入】- 關鍵突破，極高量能確認，積極進場")
elif curr_signal_type == 'SELL':
    print("   【賣出】- 趨勢轉弱，考慮出場")
else:
    print("   【觀望】- 等待更明確訊號")
