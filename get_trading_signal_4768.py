...
MODEL_FILE = 'ppo_4768_two_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (晶呈科技) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 4768 晶呈科技 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('4768', '晶呈科技', max_results=5)