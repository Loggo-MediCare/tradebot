"""
台股 2481 (PAN JIT INTERNATIONAL INC) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '2481.TW'
TICKER_NAME = 'PAN JIT INTERNATIONAL INC'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\2481.TW_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_2481_tw_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 2481.TW (PAN JIT INTERNATIONAL INC) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('2481.TW', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 PAN JIT INTERNATIONAL INC (2481.TW) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('2481.TW', 'PAN JIT INTERNATIONAL INC', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='2481_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (PAN JIT INTERNATIONAL INC)")
