"""
台股 8044 (PCHOME ONLINE INC.) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '8044.TWO'
TICKER_NAME = 'PCHOME ONLINE INC.'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\8044.TWO_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_8044_two_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 8044.TWO (PCHOME ONLINE INC.) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('8044.TWO', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 PCHOME ONLINE INC. (8044.TWO) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('8044.TWO', 'PCHOME ONLINE INC.', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='8044_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (PCHOME ONLINE INC.)")
