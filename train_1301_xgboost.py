...
print(f"測試集準確度: {test_acc*100:.2f}%")

print("\n混淆矩陣 (測試集):")
print(confusion_matrix(y_test, y_pred_test))

print("\n分類報告:")
print(classification_report(y_test, y_pred_test, target_names=['不買入', '買入']))
...
with open('model_accuracy_1301_TW.json', 'w', encoding='utf-8') as f:
    json.dump(accuracy_data, f, ensure_ascii=False, indent=2)

print(f"✅ 準確度數據已更新: model_accuracy_1301_TW.json")
...
with open('1301.TW_feature_importance.json', 'w', encoding='utf-8') as f:
    json.dump(feature_importance_data, f, ensure_ascii=False, indent=2)

print(f"✅ 特徵重要性已保存: 1301.TW_feature_importance.json")
...
print(f"準確度提升: {test_acc*100 - 41.0:+.2f}% (相比原 PPO 模型的 41%)")
print("=" * 80)
