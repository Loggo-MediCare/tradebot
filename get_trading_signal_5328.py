"""
台股 5328 (HUA JUNG COMPONENTS CO) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '5328.TWO'
TICKER_NAME = 'HUA JUNG COMPONENTS CO'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\5328.TWO_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_5328_two_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 5328.TWO (HUA JUNG COMPONENTS CO) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('5328.TWO', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 HUA JUNG COMPONENTS CO (5328.TWO) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('5328.TWO', 'HUA JUNG COMPONENTS CO', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='5328_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (HUA JUNG COMPONENTS CO)")
