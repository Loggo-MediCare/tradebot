...
TICKER = '7769.TW'
print(f"訓練 {TICKER} (霖揚) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_7769_tw_model.pkl')
    print(f"\n模型已保存: xgb_7769_tw_model.pkl")
    ...
    with open('model_accuracy_7769_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('7769_TW_feature_importance.json', 'w', encoding='utf-8') as f:
