...
TICKER = '4908.TWO'
print(f"訓練 {TICKER} (前鼎) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_4908_two_model.pkl')
    print(f"\n模型已保存: xgb_4908_two_model.pkl")
    ...
    with open('model_accuracy_4908_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('4908_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
