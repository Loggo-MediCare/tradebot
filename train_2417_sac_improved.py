"""
台股 2417 SAC 交易 AI 训练
SAC (Soft Actor-Critic) - 離策略算法，樣本效率更高
"""
import os
...
if __name__ == "__main__":
    ...
    print("開始訓練 SAC (100,000 步)...")
    model.learn(total_timesteps=100000)
    model_path = f"sac_2417_tw_improved"
    model.save(model_path)
    print(f"✅ SAC 模型已保存: {model_path}.zip")
