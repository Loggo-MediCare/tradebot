"""Batch train XGBoost + PPO — TW stocks batch 3"""
...
STOCKS = [
    ...
    ('2408', '南亞科', '2015-01-01'),
    ('2383', '台光電', '2015-01-01'),
    # Already in batch 1 but retrain with XGBoost
    ('2327', '國巨',   '2015-01-01'),
    ('6531', '愛普',   '2015-01-01'),
]

# Note: 00982A / 00991A / 00981A / 00992A are active ETFs — skipped (no OHLCV history)
...
def train_stock(code, name, start_date):
    ...
    print(f"\n{'='*60}")
    print(f"  [{STOCKS.index((code,name,start_date))+1}/{len(STOCKS)}] {code} {name} ({ticker})")
    print(f"{'='*60}")
...
if __name__ == '__main__':
    print("=" * 60)
    print(f"  BATCH 3 — {len(STOCKS)} TW Stocks (XGBoost + PPO)")
    print(f"  Started: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print(f"  Skipped ETFs: 00982A, 00991A, 00981A, 00992A")
    print("=" * 60)
    ...
    print("\n" + "=" * 66)
    print("  ACCURACY COMPARISON TABLE — Batch 3")
    print("=" * 66)
