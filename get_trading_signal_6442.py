...
def get_trading_signal():
    ...
    # ========== 載入模型 ==========
    model_path = r"C:\Users\Silvi\Projects\trading-bot\ppo_1303.TW_improved"
    ...
    try:
        ...
        df = yf.download('1303.TW', period='90d', progress=False, auto_adjust=True)
    ...
    sentiment_result = calculate_sentiment_score('1303.TW', verbose=False)
    ...
    if action_value > 0.1:
        ...
        buy_score, signal_override, buy_reasons, buy_warnings, buy_metadata, sentiment_result = \
            calculate_enhanced_buy_score_with_sentiment(
                ...
                ai_action=action_value, buy_weights=buy_weights, symbol='1303.TW'
            )
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            import yfinance as yf
            chart_df = yf.Ticker("6442.TW").history(period="6mo")
            chart_df.columns = [c.lower() for c in chart_df.columns]
            chart_path = "6442_chart.png"
            plot_candlestick(chart_df, "6442.TW", save_path=chart_path)
        except Exception as e:
            print(f"   圖表生成失敗: {e}")
