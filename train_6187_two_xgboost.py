...
TICKER = '6187.TWO'
print(f"訓練 {TICKER} (環球晶) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_6187_two_model.pkl')
    print(f"\n模型已保存: xgb_6187_two_model.pkl")
    ...
    with open('model_accuracy_6187_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('6187_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
