...
# 保存模型
model_file = 'xgb_3138_tw_model.pkl'
...
with open('model_accuracy_3138_TW.json', 'w', encoding='utf-8') as f:
...
with open('3138.TW_feature_importance.json', 'w', encoding='utf-8') as f:
