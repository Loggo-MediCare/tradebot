"""
COIN (Coinbase) Hybrid PPO + XGBoost 交易信號生成器
半導體設備龍頭股 - 準確度 65.85%
"""
import os
...
TICKER = 'COIN'
MODEL_FILE = 'xgb_coin_model.pkl'
PPO_FILE   = 'ppo_coin_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Coinbase) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    print("=" * 80)
    ...
    try:
        ...
        print(format_ppo_roi_line('COIN', 'COIN', 'ppo_coin_improved', df, ppo_action))
