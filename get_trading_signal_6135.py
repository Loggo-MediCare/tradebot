...
MODEL_FILE = 'xgb_6135_tw_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 6135.TW (新麗) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 6135 新麗 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('6135', '新麗', max_results=5)