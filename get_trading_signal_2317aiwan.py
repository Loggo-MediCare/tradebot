...
def get_trading_signal():
    ...
    sentiment_result = calculate_sentiment_score('2317.TAIWAN', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 2317.TAIWAN (2317.TAIWAN) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('2317.TAIWAN', '2317.TAIWAN', max_results=5)
    print("\n" + "=" * 60)
