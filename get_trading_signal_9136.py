...
MODEL_FILE = 'xgb_9136_tw_model.pkl'
...
def get_trading_signal():
    ...
    print(f"🤖 9136.TW (巨騰-DR) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 9136 巨騰-DR 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('9136', '巨騰-DR', max_results=5)