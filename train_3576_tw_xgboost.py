...
TICKER = '3576.TW'
print(f"訓練 {TICKER} (聯合再生) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_3576_tw_model.pkl')
    print(f"\n模型已保存: xgb_3576_tw_model.pkl")
    ...
    with open('model_accuracy_3576_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('3576_TW_feature_importance.json', 'w', encoding='utf-8') as f:
