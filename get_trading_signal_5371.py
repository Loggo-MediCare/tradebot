...
def get_trading_signal():
   ...
   # print(f("生成时间: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    ...
    accuracy_display = get_model_accuracy_display('5371.TWO')
    ...
    model_path = r"ppo_5371_two_improved"
    ...
    try:
        ...
        df = yf.download('5371.TWO', period='300d', progress=False, auto_adjust=True)  # 改为300天以计算200日均线
        ...
        try:
            ...
            ticker_info = yf.Ticker('5371.TWO').info
    ...
    ai_muted = should_mute_ai_signal('5371.TWO', threshold=52)
    ...
    try:
        ...
        profit_positive = evaluate_fundamentals_for_sell(yf, '5371.TWO')['good']
    ...
    weight_calc = DynamicWeightCalculator('5371.TWO')
    ...
    sentiment_result = calculate_sentiment_score('5371.TWO', verbose=True)
...
# 加入爆发行情评分调整
        ...
        if bb_position < 35 and sell_score > 0:
            ...
            fundamentals = evaluate_fundamentals_for_sell(yf, '5371.TWO')
        ...
        _growth = calculate_growth_score_adjustment(yf, '5371.TWO')
...
if __name__ == "__main__":
    ...
    if result:
        ...
        print(f"   {get_model_accuracy_display('5371.TWO')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 5371 5371 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('5371', '5371', max_results=5)