...
# 2. 下载和处理数据
# ==========================================
def download_and_prepare_data(ticker='2884.TW', start_date='2015-01-01', end_date='2025-01-01'):
    """
    🔥 改进 1: 下载更多年份的数据
    台股代码格式: 2884.TW
    """
...
if __name__ == "__main__":
    print("🚀 改进版台股 2884 交易 AI 训练系统")
    print("=" * 70)
    # 配置
    TICKER = '2884.TW'  # 台股 2884
