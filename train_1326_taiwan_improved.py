...
# 2. 下载和处理数据
# ==========================================
def download_and_prepare_data(ticker='1326.TW', start_date='2015-01-01', end_date='2025-06-01'):
    """
    🔥 改进 1: 下载更多年份的数据
    台股代码格式: 1326.TW
    """
    print("=" * 70)
    print(f"下载 {ticker} 股票数据 (台股 台化)...")
