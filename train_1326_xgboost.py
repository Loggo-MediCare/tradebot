"""
1326 (台塑化 Formosa Petrochemical) XGBoost 訓練
"""
import os
...
TICKER = '1326.TW'
print(f"訓練 {TICKER} (台塑化) XGBoost 模型")
print("=" * 80)
...
# 保存模型
joblib.dump(model, 'xgb_1326_tw_model.pkl')
print(f"\n模型已保存: xgb_1326_tw_model.pkl")
...
with open('model_accuracy_1326_TW.json', 'w', encoding='utf-8') as f:
...
with open('1326_TW_feature_importance.json', 'w', encoding='utf-8') as f:
