"""
Retry PPO training for the 7 TW stocks that failed with "no data" in the 21-stock
batch run (Yahoo Finance rate-limiting after ~14 sequential downloads).
...
# (code, yfinance ticker) - all failed with "no data" in train_21stocks_ppo_batch.py
STOCKS = [
    ('6949', '6949.TW'),
    ('7728', '7728.TWO'),
    ('8038', '8038.TWO'),
...
if __name__ == '__main__':
    print("=" * 70)
    print(f"重試訓練 7 支先前無資料的 TW 股票 PPO 模型")
