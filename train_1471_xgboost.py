"""
1471.TW (首利 Solytech Enterprise Corporation) XGBoost 訓練
"""
import os
...
TICKER = '1471.TW'
print(f"訓練 {TICKER} (首利 Solytech) XGBoost 模型")
print("=" * 80)
...
# 保存模型
joblib.dump(model, 'xgb_1471_tw_model.pkl')
print(f"\n模型已保存: xgb_1471_tw_model.pkl")
...
with open('model_accuracy_1471_TW.json', 'w', encoding='utf-8') as f:
...
with open('1471_TW_feature_importance.json', 'w', encoding='utf-8') as f:
