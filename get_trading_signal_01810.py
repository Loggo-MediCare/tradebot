...
港股 01810 (小米集團 (Xiaomi)) AI 交易信号生成器
...
def get_trading_signal():
    ...
    print("🤖 港股 1810.HK (小米集團 Xiaomi) AI 交易信号生成器")
   ...
   # print(f("生成时间: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    ...
    accuracy_display = get_model_accuracy_display('1810.HK')
    ...
    model_path = r"ppo_1810_hk_improved"
    ...
    try:
        ...
        df = yf.download('1810.HK', period='300d', progress=False, auto_adjust=True)  # 改为300天以计算200日均线
        ...
        try:
            ...
            ticker_info = yf.Ticker('1810.HK').info
    ...
    ai_muted = should_mute_ai_signal('1810.HK', threshold=52)
    ...
    try:
        ...
        profit_positive = evaluate_fundamentals_for_sell(yf, '1810.HK')['good']
    ...
    weight_calc = DynamicWeightCalculator('1810.HK')
    ...
    sentiment_result = calculate_sentiment_score('1810.HK', verbose=True)
...
# 加入爆发行情评分调整
        ...
        if bb_position < 35 and sell_score > 0:
            ...
            fundamentals = evaluate_fundamentals_for_sell(yf, '1810.HK')
        ...
        _growth = calculate_growth_score_adjustment(yf, '1810.HK')
...
if __name__ == "__main__":
    ...
    if result:
        ...
        print(f"   {get_model_accuracy_display('1810.HK')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 01810 小米集團 (Xiaomi 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('01810', '小米集團 (Xiaomi', max_results=5)