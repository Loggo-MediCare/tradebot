"""
MPWR (Monolithic Power Systems) Trading AI Training
==========================================
"""
import os
...
if __name__ == "__main__":
    ...
    TICKER = 'MPWR'
    START_DATE = '2015-01-01'  # MPWR IPO was May 2012 (as Facebook)
    END_DATE = '2026-01-01'
    TOTAL_TIMESTEPS = 100000

    print(f"Training {TICKER} (Monolithic Power Systems)")
