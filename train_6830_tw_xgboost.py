...
TICKER = '6830.TW'
print(f"訓練 {TICKER} (汎銓) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_6830_tw_model.pkl')
    print(f"\n模型已保存: xgb_6830_tw_model.pkl")
    ...
    with open('model_accuracy_6830_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('6830_TW_feature_importance.json', 'w', encoding='utf-8') as f:
