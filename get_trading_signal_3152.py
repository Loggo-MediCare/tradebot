"""
台股 3152 (ADVANCED CERAMIC X CORP) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '3152.TWO'
TICKER_NAME = 'ADVANCED CERAMIC X CORP'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\3152.TWO_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_3152_two_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 3152.TWO (ADVANCED CERAMIC X CORP) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('3152.TWO', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 ADVANCED CERAMIC X CORP (3152.TWO) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('3152.TWO', 'ADVANCED CERAMIC X CORP', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='3152_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (ADVANCED CERAMIC X CORP)")
