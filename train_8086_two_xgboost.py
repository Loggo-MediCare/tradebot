...
TICKER = '8086.TWO'
print(f"訓練 {TICKER} (宏捷科) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_8086_two_model.pkl')
    print(f"\n模型已保存: xgb_8086_two_model.pkl")
    ...
    with open('model_accuracy_8086_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('8086_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
