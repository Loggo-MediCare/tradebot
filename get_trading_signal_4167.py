...
def get_trading_signal():
    ...
    try:
        ...
        df = yf.download('4167.TW', period='300d', progress=False, auto_adjust=True)  # 改为300天以计算200日均线
        ...
        try:
            ...
            ticker_info = yf.Ticker('4167.TW').info
    ...
    ai_muted = should_mute_ai_signal('4167.TW', threshold=52)
    ...
    try:
        ...
        profit_positive = evaluate_fundamentals_for_sell(yf, '4167.TW')['good']
    ...
    weight_calc = DynamicWeightCalculator('4167.TW')
    ...
    sentiment_result = calculate_sentiment_score('4167.TW', verbose=True)
...
# 加入爆发行情评分调整
        ...
        if bb_position < 35 and sell_score > 0:
            ...
            fundamentals = evaluate_fundamentals_for_sell(yf, '4167.TW')
        ...
        _growth = calculate_growth_score_adjustment(yf, '4167.TW')
