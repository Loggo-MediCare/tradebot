...
TICKER = '8438.TW'
print(f"訓練 {TICKER} (昶昕) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_8438_tw_model.pkl')
    print(f"\n模型已保存: xgb_8438_tw_model.pkl")
    ...
    with open('model_accuracy_8438_TW.json', 'w', encoding='utf-8') as f:
    ...
    with open('8438_TW_feature_importance.json', 'w', encoding='utf-8') as f:
