...
def get_trading_signal():
    ...
    accuracy_display = get_model_accuracy_display('1314')


    print(f"🤖 1314.TW (中石化) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    ...
    model_filename = "ppo_1314_improved"
    ...
    try:
        ...
        df = yf.download('1314.TW', period='300d', progress=False, auto_adjust=True)  # 改为300天以计算200日均线
        ...
        try:
            ...
            ticker_info = yf.Ticker('1314.TW').info
    ...
    ai_muted = should_mute_ai_signal('1314', threshold=52)
    ...
    try:
        ...
        profit_positive = evaluate_fundamentals_for_sell(yf, '1314.TW')['good']
    ...
    weight_calc = DynamicWeightCalculator('1314')
    ...
    sentiment_result = calculate_sentiment_score('1314', verbose=True)
    ...
    if action_value > 0.1:
        ...
        if bb_position < 35 and sell_score > 0:
            ...
            fundamentals = evaluate_fundamentals_for_sell(yf, '1314.TW')
        ...
        _growth = calculate_growth_score_adjustment(yf, '1314.TW')
...
if __name__ == "__main__":
    ...
    if result:
        ...
        print(f"   {get_model_accuracy_display('1314')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 1314 中石化 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('1314', '中石化', max_results=5)