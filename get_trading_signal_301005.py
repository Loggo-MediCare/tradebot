...
def get_trading_signal():
    ...
    sentiment_result = calculate_sentiment_score('301005.SZ', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 301005.SZ (301005.SZ) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('301005.SZ', '301005.SZ', max_results=5)
    print("\n" + "=" * 60)
