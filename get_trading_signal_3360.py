...
def get_trading_signal():
    ...
    accuracy_display = get_model_accuracy_display('3360')


    print(f"🤖 3360 (尚志) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    ...
    model_path = r"ppo_3360_tw_improved"
...
if __name__ == "__main__":
    ...
    if result:
        ...
        print(f"   {get_model_accuracy_display('3360')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 3360 尚志 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('3360', '尚志', max_results=5)