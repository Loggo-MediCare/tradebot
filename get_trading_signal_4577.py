...
MODEL_FILE = 'ppo_4577_two_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (達航科技) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 4577 達航科技 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('4577', '達航科技', max_results=5)