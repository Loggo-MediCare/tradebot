...
def get_trading_signal():
   ...
   # print(f("生成时间: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    ...
    accuracy_display = get_model_accuracy_display('5274.TWO')
    ...
    model_path = r"C:\Users\Silvi\Projects\trading-bot\ppo_5274_two_improved"
    ...
    try:
        ...
        df = yf.download('5274.TWO', period='90d', progress=False, auto_adjust=True)
        ...
        try:
            ...
            ticker_info = yf.Ticker('5274.TWO').info
    ...
    weight_calc = DynamicWeightCalculator('5274.TWO')
    ...
    sentiment_result = calculate_sentiment_score('5274.TWO', verbose=False)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            chart_df = yf.Ticker("5274.TWO").history(period="6mo")


            chart_df.columns = [c.lower() for c in chart_df.columns]


            chart_path = "5274_chart.png"


            plot_candlestick(chart_df, "5274.TWO", save_path=chart_path)
        ...
        print(f"   {get_model_accuracy_display('5274.TWO')}")
...
if __name__ == '__main__':
    print('\n' + '=' * 80)
    print('🌐 5274 信驊 即時新聞  (Tavily REST API)')
    print('=' * 80)
    print_tavily_news_tw('5274', '信驊', max_results=5)