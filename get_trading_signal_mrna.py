"""
MRNA (Moderna) Hybrid PPO + XGBoost 交易信號生成器
半導體設備龍頭股 - 準確度 60.44%
"""
import os
...
TICKER = 'MRNA'
MODEL_FILE = 'xgb_mrna_model.pkl'
PPO_FILE   = 'ppo_mrna_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Moderna) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    print("=" * 80)
    ...
    try:
        ...
        print(format_ppo_roi_line('MRNA', 'MRNA', 'ppo_mrna_improved', df, ppo_action))
