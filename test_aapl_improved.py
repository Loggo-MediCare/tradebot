...
ax1.set_title('改进版 AI: AAPL 价格走势和交易决策 (2024年)', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig('aapl_improved_results.png', dpi=150, bbox_inches='tight')
print(f"\n📊 图表已保存: aapl_improved_results.png")
plt.show()
