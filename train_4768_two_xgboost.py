...
TICKER = '4768.TWO'
print(f"訓練 {TICKER} (晶呈科技) XGBoost 模型")
print("=" * 80)
...
try:
    ...
    # 保存模型
    joblib.dump(model, 'xgb_4768_two_model.pkl')
    print(f"\n模型已保存: xgb_4768_two_model.pkl")
    ...
    with open('model_accuracy_4768_TWO.json', 'w', encoding='utf-8') as f:
    ...
    with open('4768_TWO_feature_importance.json', 'w', encoding='utf-8') as f:
