...
TICKER = '1717.TW'
TICKER_NAME = '長興'
MODEL_PATH = r'C:\Users\Silvi\Projects\trading-bot\1717.TW_improved_anti_overfit_model.keras'
WINDOW_SIZE = 5
...
def get_trading_signal():
    ...
    sentiment_result = calculate_sentiment_score('1717.TW', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 長興 (1717.TW) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('1717.TW', '長興', max_results=5)
    print("\n" + "=" * 80)
    print("⚠️  风险提示")
    print("=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path=f"1717_chart.png")
        except Exception as e:
            print(f"   圖表生成失敗: {e}")
