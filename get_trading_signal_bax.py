"""
BAX (Baxter) Hybrid PPO + XGBoost 交易信號生成器
半導體設備龍頭股 - 準確度 75.44%
"""
import os
...
TICKER = 'BAX'
MODEL_FILE = 'xgb_bax_model.pkl'
PPO_FILE   = 'ppo_bax_improved'
...
def get_trading_signal():
    ...
    print(f"🤖 {TICKER} (Baxter) | 準確度: {accuracy_display} | {datetime.now().strftime('%Y-%m-%d %H:%M')}")
    print("=" * 80)
    ...
    try:
        ...
        print(format_ppo_roi_line('BAX', 'BAX', 'ppo_bax_improved', df, ppo_action))
