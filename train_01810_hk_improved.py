"""
改进版 01810.HK 股票交易 AI 训练 (Hong Kong)
"""
import os
...
def download_and_prepare_data(ticker='1810.HK', start_date='2015-01-01', end_date='2025-01-31'):
    print("=" * 70)
...
if __name__ == "__main__":
    print("🚀 改进版 01810.HK 交易 AI 训练系统 (Hong Kong)")
    print("=" * 70)
    TICKER = '1810.HK'
