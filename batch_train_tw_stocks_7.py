"""
Batch Training Script for Taiwan Stocks (Batch 7)
Trains: 6988, 1809, 6485, 1802, 2431, 4561, 6683, 2484, 5289, 5228, 4958, 8438, 8436, 2486, 6492, 3693, 3051, 5340
Note: 6443, 4540, 8110, 6515, 1605, 2451 already trained
Note: 1802 might be in batch 3
"""
import subprocess
import sys
import os
...
TW_STOCKS = [
    '6988', '1809', '6485', '1802', '2431', '4561',
    '6683', '2484', '5289', '5228', '4958', '8438',
    '8436', '2486', '6492', '3693', '3051', '5340'
]
...
if __name__ == "__main__":
    print("="*70)
    print("Batch Training for Taiwan Stocks (Batch 7)")
    print("="*70)
