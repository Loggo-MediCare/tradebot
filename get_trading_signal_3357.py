"""
台股 3357 (台慶科) AI 交易信号生成器 (PPO / DQN 自動選最佳)
"""
import os
...
TICKER      = '3357.TWO'
TICKER_NAME = '台慶科'
DQN_PATH    = r'C:\Users\Silvi\Projects\trading-bot\3357.TWO_improved_anti_overfit_model.keras'
PPO_PATH    = r'C:\Users\Silvi\Projects\trading-bot\ppo_3357_two_improved'
WINDOW_SIZE  = 5
...
def get_trading_signal():
    print("=" * 80)
    print(f"AI 3357.TWO (台慶科) 交易信号生成器")
    ...
    sentiment_result = calculate_sentiment_score('3357.TWO', verbose=False)
    ...
    # ── Tavily 即時新聞 ─────────────────────────────────────────────────────
    print("\n" + "=" * 80)
    print("🌐 台慶科 (3357.TWO) 即時新聞  (Tavily REST API)")
    print("=" * 80)
    print_tavily_news('3357.TWO', '台慶科', max_results=5)
    print("\n" + "=" * 80)
...
if __name__ == "__main__":
    ...
    if result:
        ...
        try:
            ...
            plot_candlestick(chart_df, TICKER, save_path='3357_chart.png')
        except Exception as e:
            print(f"图表生成失败: {e}")
        print(f"\n股票: {result['symbol']} (台慶科)")
