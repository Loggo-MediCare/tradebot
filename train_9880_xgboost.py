"""
訓練 9880.HK (Ubtech Robotics) XGBoost 模型
"""
import os
...
def main():
    print("=" * 80)
    print("訓練 9880.HK (Ubtech Robotics) XGBoost 模型")
    print("=" * 80)
    ...
    # 下載數據
    print("\n下載 9880.HK 歷史數據...")
    df = yf.download('9880.HK', start='2015-01-01', end='2026-12-31', progress=False)
    ...
    with open('model_accuracy_9880.json', 'w', encoding='utf-8') as f:
    ...
    with open('9880_HK_feature_importance.json', 'w', encoding='utf-8') as f:
